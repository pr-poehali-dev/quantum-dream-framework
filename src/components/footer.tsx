      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="font-space-mono text-gray-300 mb-6 max-w-md">
              Игровой голосовой мессенджер нового поколения. Общайся, играй, побеждай.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#technology"
                  className="font-space-mono text-gray-400 hover:text-violet-400 transition-colors duration-200"
                >
                  Возможности
                </a>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-violet-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-space-mono text-gray-400 text-sm">2026 NexusTalk. Все права защищены.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a
                href="#"
                className="font-space-mono text-gray-400 hover:text-violet-400 text-sm transition-colors duration-200"
              >
                Конфиденциальность
              </a>
              <a
