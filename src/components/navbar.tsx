...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[9999] bg-black/95 backdrop-blur-md border-b border-violet-500/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex-shrink-0">
            <h1 className="font-orbitron text-xl font-bold text-white">
              Nexus<span className="text-violet-500">Talk</span>
            </h1>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a href="#safety" className="font-geist text-white hover:text-violet-400 transition-colors duration-200">
                Безопасность
              </a>
          ...
          {/* CTA Button */}
          <div className="hidden md:block">
            <Button className="bg-violet-600 hover:bg-violet-700 text-white font-geist border-0">Скачать бесплатно</Button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/98 border-t border-violet-500/30">
              <a
                href="#technology"
